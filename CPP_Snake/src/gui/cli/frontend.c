...
void printTable(void) {
  ...
  mvprintw(2, FIELD_X * 2 + 3, "SCORE:");
  mvprintw(4, FIELD_X * 2 + 3, "HIGH SCORE:");
  ...
  mvprintw(FIELD_Y - 0, FIELD_X * 2 + 2, "q - Exit game");
}
...
void printStartScreen() {
  ...
  mvprintw(FIELD_Y / 2 + 1, FIELD_X / 2, "Press 's'");
...
void printGameOverScreen() {
  ...
  mvprintw(FIELD_Y / 2 - 2, FIELD_X / 2, "Press 's'");
  mvprintw(FIELD_Y / 2 - 1, FIELD_X / 2, "to start");
  mvprintw(FIELD_Y / 2, FIELD_X / 2, "or 'q'");
  mvprintw(FIELD_Y / 2 + 1, FIELD_X / 2, "to finish");
  move(FIELD_Y + 1, FIELD_X * 2 + INFO_X * 2 + 3);
}

void printInfo(GameParams_t *game) {
  mvprintw(2, FIELD_X * 2 + 14, "%d", game->data->score);
  mvprintw(4, FIELD_X * 2 + 14, "%d", game->data->high_score);
...
void print_pause() {
  ...
  mvprintw(FIELD_Y / 2 - 2, FIELD_X / 3 + 1, "Press 's' to");
